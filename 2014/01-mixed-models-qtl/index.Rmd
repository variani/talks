...
>* SOLAR: Sequential Oligogenic Linkage Analysis Routines `r citep(bib["Blangero1996"])`.
...
>* R package [MCMCglmm](http://cran.r-project.org/web/packages/MCMCglmm/index.html):
  MCMC Generalised Linear Mixed Models `r citep(bib["Hadfield2010a"])`.
...
A model in which $n$ QTLs and polygenes influence a quantitative trait `r citep(bib["Almasy1998"])`:
...
See `r citep(bib["Lynch1998"])`, Appendix 3, pp. 842.
...
See `r citep(bib["Lynch1998"])`, Chapter 26, pp. 746.
...
See `r citep(bib["Lynch1998"])`, Chapter 27.
</p></div>
...
>* Rönnegård and Carlborg have shown a statistically equivalent definition of `G` matrix
  via an incidence matrix `Z` `r citep(bib["Ronnegard2007"])`. 
...
>4. <b>Book `r citep(bib["Lynch1998"])`</b>, Chapters 26 and 27
