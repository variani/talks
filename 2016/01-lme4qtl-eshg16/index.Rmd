...
# lme4qtl is <span class="emph">flexible</span> | AB0 influences both mean and variance of APTT <br/> *Don't confuse it with model in [@Chen2007]
...
```{r, echo = TRUE}
mibd[1:4, 1:4] # a submatrix of 449 x 449
```
