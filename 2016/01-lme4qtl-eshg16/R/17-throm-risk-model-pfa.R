...
dat <- within(dat, {
  PFAadp_q10 <- factor(ifelse(PFAadp < quantile(PFAadp, 0.1, na.rm =  TRUE), "low", "high"))
  PFAepin_q10 <- factor(ifelse(PFAepin < quantile(PFAepin, 0.1, na.rm =  TRUE), "low", "high"))
  PFAadp_q20 <- factor(ifelse(PFAadp < quantile(PFAadp, 0.2, na.rm =  TRUE), "low", "high"))
  PFAepin_q20 <- factor(ifelse(PFAepin < quantile(PFAepin, 0.2, na.rm =  TRUE), "low", "high"))
})
